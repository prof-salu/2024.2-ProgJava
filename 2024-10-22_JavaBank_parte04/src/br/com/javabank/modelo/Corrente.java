...
import br.com.javabank.exceptions.SaqueInvalidoException;
...
public final class Corrente extends Conta{
    ...
    public boolean sacar(double valor) {
        ...
        if(valor <= 0){
            ...
            //throw new IllegalArgumentException("Valor ZERO ou negativo");
            throw new SaqueInvalidoException("Valor invalido");
        }
